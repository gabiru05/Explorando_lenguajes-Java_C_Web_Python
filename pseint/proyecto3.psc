Algoritmo sin_titulo
	...
	SiNo
		contadorA = NOA
		imprimir Sin Saltar(" [ A ] es de igual cantidad a otra nota  ");imprimir Sin Saltar(contadorA);
	...
	SiNo
		...
		contadorB = NOB
		imprimir Sin Saltar(" [ B ] es de igual cantidad a otra nota  ");imprimir Sin Saltar(contadorB);
	...
	SiNo
		contadorC = NOC
		imprimir Sin Saltar(" [ C ] es de igual cantidad a otra nota  ");imprimir Sin Saltar(contadorC);
	...
	SiNo
		...
		contadorD = NOD
		imprimir Sin Saltar(" [ D ] es de igual cantidad a otra nota  ");imprimir Sin Saltar(contadorD);
	...
	SiNo
		contadorF = NOF
		imprimir Sin Saltar(" [ F ] es de igual cantidad a otra nota  ");imprimir Sin Saltar(contadorF);
