Algoritmo Grupo_Notas
	...
	Mientras (terminar==1)
		...
		//contador de ciclo y asi saber las notas totales
		contador=contador+1;
		//calculo promedio
		Sum = Sum + AlumNo
	...
	imprimir Sin Saltar("El promedio de las ");imprimir Sin Saltar(contador),(" notas es : "),(Prom);
	...
	// inicio si repite menos
	
	si (NOA<=NOB & NOA<=NOC & NOA<=NOD & NOA<=NOF)
		contadorA = NOA
		imprimir Sin Saltar("La nota que menos se repite es la A con una cantidad de  ");imprimir Sin Saltar(contadorA);
		
	FinSi
	
	si (NOB<=NOA & NOB<=NOC & NOB<=NOD & NOB<=NOF)
		contadorB = NOB
		imprimir Sin Saltar("La nota que menos se repite es la B con una cantidad de  ");imprimir Sin Saltar(contadorB);
	...
	si (NOC<=NOA & NOC<=NOB & NOC<=NOD & NOC<=NOF)
		contadorC = NOC
		imprimir Sin Saltar("La nota que menos se repite es la C con una cantidad de  ");imprimir Sin Saltar(contadorC);
		
	FinSi
	
	si (NOD<=NOB & NOD<=NOC & NOD<=NOA & NOD<=NOF)
		contadorD = NOD
		imprimir Sin Saltar("La nota que menos se repite es la D con una cantidad de  ");imprimir Sin Saltar(contadorD);
		
	FinSi
	
	si (NOF<=NOB & NOF<=NOC & NOF<=NOD & NOF<=NOA)
		contadorF = NOF
		imprimir Sin Saltar("La nota que menos se repite es la F con una cantidad de  ");imprimir Sin Saltar(contadorF);
